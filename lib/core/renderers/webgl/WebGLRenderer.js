...
var WebGLRenderer = function (_SystemRenderer) {
    ...
    function WebGLRenderer(options, arg2, arg3) {
        ...
        if (typeof _this.view.addEventListener !== 'undefined') {
        ...
        var _ref = _this.options || _this.view,
            width = _ref.width,
            height = _ref.height;

        _this.gl = _this.options.context || _pixiGlCore2.default.createContext(_this.view, _this._contextOptions, width, height);
